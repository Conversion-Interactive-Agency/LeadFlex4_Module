...
var joinComponent = function (arr, str, sep) {
  str = str || 'and';
  sep = sep || ', ';
...
function createRequest(config) {
  ...
  const url = buildURL$1(fullPath, config.params, config.paramsSerializer);
...
var Analytics = /*#__PURE__*/function () {
  ...
  _createClass(Analytics, [{
    ...
    value: function _isErrorRetryable(error) {
      ...
      this.logger.error("error status: ".concat(error.response.status));
